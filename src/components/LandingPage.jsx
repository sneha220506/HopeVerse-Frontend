...
export default function LandingPage({ onLogin, onRegister }) {
  ...
  const criticalCount = communityNeeds.filter(
    (n) => n.urgency === "critical",
  ).length;
  const totalAffected = communityNeeds.reduce(
    (s, n) => s + n.affectedPeople,
    0,
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <button
                onClick={onLogin}
                className="text-gray-300 hover:text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-gray-800 transition-colors"
              >
                Sign In
              </button>
              <button
                onClick={onRegister}
                className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:from-emerald-600 hover:to-teal-600 transition-all shadow-lg shadow-emerald-500/25"
              >
                Get Started
              </button>
            </div>
            <div className="md:hidden flex items-center gap-2">
              <button
                onClick={onLogin}
                className="text-gray-300 hover:text-white text-sm px-3 py-1.5"
              >
                Sign In
              </button>
              <button
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            ...
            Intelligently match volunteers with the tasks where they can create
            the greatest impact.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-xl mx-auto">
              Everything you need to coordinate volunteers and manage community
              impact
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Visualize urgent needs across all zones with interactive maps and filters",
                color: "from-red-500/20 to-red-600/10",
              },
              {
                icon: "👥",
                title: "Volunteer Directory",
                desc: "Search, filter, and manage volunteers by skills, availability, and location",
                color: "from-emerald-500/20 to-emerald-600/10",
              },
              {
                icon: "🤖",
                title: "Smart Matching",
                desc: "AI-powered algorithm matches volunteers to needs based on 7 weighted factors",
                color: "from-blue-500/20 to-blue-600/10",
              },
              {
                icon: "📋",
                title: "Task Board",
                desc: "Kanban-style task management with assignment tracking and progress monitoring",
                color: "from-purple-500/20 to-purple-600/10",
              },
              {
                icon: "📝",
                title: "Field Reports",
                desc: "Collect and verify survey data from field workers and community leaders",
                color: "from-amber-500/20 to-amber-600/10",
              },
              {
                icon: "📊",
                title: "Analytics Dashboard",
                desc: "Data-driven insights with charts, donut graphs, and regional performance",
                color: "from-teal-500/20 to-teal-600/10",
              },
            ].map((f, i) => (
              <div
                key={i}
                className={`bg-gradient-to-br ${f.color} backdrop-blur-sm rounded-xl border border-gray-700/50 p-6 hover:-translate-y-1 transition-all`}
              >
      ...
      <section id="how-it-works" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-xl mx-auto">
              From data collection to action in 4 simple steps
            </p>
          </div>
            ...
            {[
              {
                step: "1",
                title: "Collect Data",
                desc: "Field workers submit surveys and reports from the ground",
                icon: "📝",
              },
              {
                step: "2",
                title: "Identify Needs",
                desc: "Scattered data is organized into actionable community needs",
                icon: "🔍",
              },
              {
                step: "3",
                title: "Smart Match",
                desc: "Our algorithm finds the best volunteers for each need",
                icon: "🤖",
              },
              {
                step: "4",
                title: "Track Impact",
                desc: "Monitor progress, measure results, and improve over time",
                icon: "📊",
              },
            ].map((s, i) => (
              <div key={i} className="text-center">
                <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center text-2xl mx-auto mb-4 shadow-lg shadow-emerald-500/20">
                  {s.icon}
                </div>
          ...
          <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-2xl border border-emerald-500/20 p-8 md:p-12">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-400">
                Real numbers from our community operations
              </p>
            </div>
      ...
      <section className="py-20 bg-gray-800/30">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 mb-8 text-lg">
            Join thousands of volunteers coordinating social impact through
            technology
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-500 text-sm">
              © 2026 CommunityPulse. Smart Resource Allocation for Social
              Impact. MERN Stack.
            </p>
          </div>
        </div>
